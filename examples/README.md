...
Los ejemplos versionan únicamente el Design, el objetivo y evidencia compacta. Las carpetas
de proyecto (`workspace/`), ejecuciones, exportaciones y archivos `.mph` se regeneran y están
excluidos de Git.
